      ...
      {gameState === 'intro' && (
        <div className="bg-white rounded-3xl border-2 border-slate-200 shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-teal-900 via-emerald-900 to-indigo-950 p-6 sm:p-10 text-white relative overflow-hidden">
            <div className="absolute -right-10 -bottom-10 w-64 h-64 bg-[radial-gradient(circle,rgba(20,184,166,0.25)_0%,transparent_70%)] pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="relative shrink-0 flex items-center justify-center">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(45,212,191,0.35)_0%,transparent_70%)] pointer-events-none" />
