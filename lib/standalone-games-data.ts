...
export const STANDALONE_GAMES: StandaloneGame[] = [
  {
    ...
    category: 'math',
    categoryLabel: 'Matematik & Mantık',
    categoryIcon: '🔢',
    badge: 'Tasarım Aşamasında',
    badgeColor: 'bg-amber-100 text-amber-900 border-amber-300',
    description: 'Zamana karşı dört işlem, basamak değerleri ve problem çözme reflekslerinizi test edin.',
