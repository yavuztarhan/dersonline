...
export const STANDALONE_GAMES: StandaloneGame[] = [
  {
    id: 'matematik-carki',
    title: 'Matematik Çarkı & Hızlı İşlem',
    category: 'math',
    categoryLabel: 'Matematik & Refleks',
    categoryIcon: '🎡',
    badge: 'Yeni & Popüler 🌟',
    badgeColor: 'bg-amber-100 text-amber-900 border-amber-300',
    description: 'Dönen çarktan gelen dört işlem ve sürpriz çarpanlarla süren bitmeden en doğru cevabı bul, komboları katla!',
  ...
  },
  {
    ...
    description: '1-10 arası sayıların çarpımını 20 saniye içinde en hızlı şekilde çözün. Her doğru cevapta +1 saniye kazanın!',
    difficulty: 'Tüm Seviyeler',
    duration: '20+ sn',
    xpReward: 100,
    playsCount: 42,
