...
const SEED_STUDENT_ACTIVITIES: StudentActivityScore[] = [
  // Çırak Hasan (stu-201 / 104) - High performer across all outcomes
  {
    id: 'act-201-1',
    studentId: 'stu-201',
    ...
    gameTitle: 'Kavram Hafıza Kartı & Kelime Avı',
    score: 95,
    maxScore: 100,
    percentage: 95,
    xpEarned: 140,
  ...
  },
  {
    ...
    gameType: 'construction-bench',
    gameTitle: 'Pergel & Gönye Eş Parça İnşası',
    score: 90,
    maxScore: 100,
    percentage: 90,
    xpEarned: 150,
  ...
  },
  {
    ...
    gameType: 'angle-radar',
    gameTitle: 'Radar Açı Ölçme & İletki Simülasyonu',
    score: 100,
    maxScore: 100,
    percentage: 100,
    xpEarned: 180,
    completedAt: '2026-09-07T09:20:00Z'
  },
  {
    id: 'act-201-4',
    studentId: 'stu-201',
    ...
    outcomeTitle: 'Düzlemde Doğruların Durumları ve Açı Çıkarımları',
    gameType: 'junction-architect',
    gameTitle: 'Kavşak Mimarı & Ters Açı Çıkarım Deneyi',
    score: 95,
    maxScore: 100,
    percentage: 95,
    xpEarned: 150,
    completedAt: '2026-09-08T15:10:00Z'
  },

  // Elif Çelik (stu-202 / 215)
  {
    id: 'act-202-1',
    studentId: 'stu-202',
    ...
    outcomeTitle: 'Açıları Ölçmek İçin Matematiksel Araç ve Teknolojiden Yararlanabilme',
    gameType: 'angle-radar',
    gameTitle: 'Radar Açı Ölçme Simülasyonu',
    score: 100,
    maxScore: 100,
    percentage: 100,
    xpEarned: 180,
  ...
  },
  {
    ...
    outcomeTitle: 'Düzlemde Doğruların Durumları ve Açı Çıkarımları',
    gameType: 'junction-architect',
    gameTitle: 'Kavşak Mimarı Oyunu & Doğru/Yanlış',
    score: 90,
    maxScore: 100,
    percentage: 90,
    xpEarned: 130,
  ...
  },
  {
    ...
    outcomeTitle: 'Doğru, Doğru Parçası ve Işın ile İlgili Temel Geometrik Çizimler',
    gameType: 'memory-cards',
    gameTitle: 'Kavram Hafıza Kartı Oyunu',
    score: 85,
    maxScore: 100,
    percentage: 85,
    xpEarned: 110,
  ...
  // Ahmet Yılmaz (stu-204 / 108 / stu-101)
  {
    id: 'act-101-1',
    studentId: 'stu-101',
  ...
  },
  {
    ...
    outcomeTitle: 'Düzlemde Doğruların Durumları ve Açı Çıkarımları',
    gameType: 'junction-architect',
    gameTitle: 'Kavşak Mimarı & Doğruların Durumları',
    score: 85,
    maxScore: 100,
    percentage: 85,
    xpEarned: 120,
  ...
  },
  {
    ...
    outcomeTitle: 'Düzlemde Doğruların Durumları ve Açı Çıkarımları',
    gameType: 'memory-cards',
    gameTitle: 'Hafıza Kartı & Mini Test',
    score: 80,
    maxScore: 100,
    percentage: 80,
    xpEarned: 110,
    completedAt: '2026-09-08T13:15:00Z'
  },

  // Mustafa Demir (stu-103)
  {
    id: 'act-103-1',
    studentId: 'stu-103',
    ...
    percentage: 75,
    xpEarned: 90,
    completedAt: '2026-09-08T10:45:00Z'
  }
];
