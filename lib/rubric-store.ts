...
const INITIAL_SUBMISSIONS: RubricSubmissionRecord[] = [
  ...
  // 5-A Şubesi - MAT.5.3.4 (Doğruların Durumları ve Açı Çıkarımları)
  {
    id: 'sub-5a-401',
    studentId: 'stu-101',
    studentName: 'Ahmet Yılmaz',
    ...
    percentage: 100,
    performanceLevel: 'Mükemmel',
    studentNote: 'Kesişen doğrularda ters açıların daima eşit olduğunu ve komşu açıların toplamının 180° ettiğini dinamik tabloda kanıtladım.',
    teacherFeedback: 'Harika bir çıkarım ve muhakeme örneği sergiledin Ahmet, tebrikler!',
    submittedAt: '2026-09-08T11:15:00Z'
  },
  {
    id: 'sub-5a-402',
    ...
    percentage: 95,
    performanceLevel: 'Mükemmel',
    studentNote: 'Tümler açının 90°, bütünler açının 180° olduğunu kavşak kilidi oyununda pekiştirdim.',
    teacherFeedback: 'Açı ilişkilerini çok hızlı ve doğru çözümlüyorsun Zeynep.',
  ...
  },
  {
    ...
    outcomeCode: 'MAT.5.3.4',
    outcomeTitle: 'Düzlemde İki veya Üç Doğrunun Birbirine Göre Durumuna Bağlı Olarak Oluşabilecek Açılara Dair Çıkarım Yapabilme',
    ratings: { c1: 3, c2: 4, c3: 3, c4: 3, c5: 3 },
    totalScore: 16,
    maxScore: 20,
    percentage: 80,
    performanceLevel: 'Başarılı',
    studentNote: 'Paralel iki doğruyu kesen üçüncü doğrunun oluşturduğu 8 açıyı inceledim.',
    teacherFeedback: 'Başarılı bir çalışma Mustafa. Kesen doğru üzerindeki açı eşitliklerine biraz daha odaklanabilirsin.',
    submittedAt: '2026-09-08T11:25:00Z'
  },
  {
    id: 'sub-5a-404',
    studentId: 'stu-104',
    ...
    percentage: 100,
    performanceLevel: 'Mükemmel',
    studentNote: 'Dinamik laboratuvarda doğruları döndürdüğümde ters açıların eşitliğinin hiç bozulmadığını gördüm.',
    teacherFeedback: 'Kavramsal anlama ve araç kullanımın üst düzeyde Elif, tebrik ederim.',
  ...
  },
  {
    ...
    percentage: 70,
    performanceLevel: 'Orta',
    studentNote: 'Tümler açı (90°) ve bütünler açı (180°) kavramlarını tekrar çalışacağım.',
    teacherFeedback: 'Caner, açı terazisi oyununda pratik yaparak tümler ve bütünler dengesini geliştirebilirsin.',
    submittedAt: '2026-09-08T11:35:00Z'
  }
];
